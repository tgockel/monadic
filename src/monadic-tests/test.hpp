...
**/
#ifndef __MONADIC_TESTS_TEST_HPP_INCLUDED__
#define __MONADIC_TESTS_TEST_HPP_INCLUDED__
...
#define TEST(name_)                            \
    class name_ ## _test :                     \
            public ::monadic_tests::unit_test  \
    {                                          \
    public:                                    \
        name_ ## _test() :                     \
            ::monadic_tests::unit_test(#name_) \
        { }                                    \
                                               \
        void run_impl();                       \
...
#endif/*__MONADIC_TESTS_TEST_HPP_INCLUDED__*/
